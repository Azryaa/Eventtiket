...
@section('content')
    ...
    <section id="events" class="max-w-7xl mx-auto px-6 py-20">
        ...
        <!-- Blok Navigasi Filter Kategori (Sekarang Di Atas Grid) -->
        <div class="mb-10 flex gap-4 flex-wrap justify-start">
            ...
            <!-- Iterasi Nama Tab Kategori Dinamis -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden">
                <div class="relative overflow-hidden aspect-[3/4]">
                    <!-- Gambar Dinamis: Menggunakan asset storage jika ada, jika tidak placeholder -->
